...
class NumberCastFail extends CommonTest{
    ...
    Stream<DynamicTest> dynamicTestsFromStream() throws Exception {
		return Files.walk(Paths.get("src/test/resources/specificationMapper/numberCastFail/"), 1)
	...
	private void executeMapping(Path srcPath) throws Exception {
        ...
        SkillFile sf = SkillFile.open("src/test/resources/specificationMapper/numberCastFail/specification.sf");
